...
header faclon_t {
    ...
    bit<HDR_SRC_ID_SIZE> src_id; // workerID for Tors. ToRID for spines.
...
struct falcon_metadata_t {
    ...
    bit<8> cluster_num_valid_ds; // Holds number of actual downstream elements (workers/tor scheds) in current cluster
    bit<HDR_SRC_ID_SIZE> idle_downstream_id;
    bit<HDR_QUEUE_LEN_SIZE> qlen_curr;
    bit<HDR_QUEUE_LEN_SIZE> qlen_agg;
    bit<HDR_QUEUE_LEN_SIZE> qlen_rand_1;
    bit<HDR_QUEUE_LEN_SIZE> qlen_rand_2;
    bit<HDR_QUEUE_LEN_SIZE> min_qlen;
